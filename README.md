...
This is **NOT** the official repository of the Swin Transformer. The original code can be found at: [https://github.com/microsoft/Swin-Transformer](https://github.com/microsoft/Swin-Transformer).
