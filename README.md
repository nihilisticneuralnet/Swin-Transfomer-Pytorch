...
Pytorch Implementation of the [Swin Transformer](https://arxiv.org/pdf/2103.14030.pdf) architecture. 
...
This is **NOT** the official repository of the Swin Transformer. The original code can be found later at: [https://github.com/microsoft/Swin-Transformer](https://github.com/microsoft/Swin-Transformer).
...
```python
import torch
import swin_tranformer_pytorch
...
- VisionTransformer repository [https://github.com/lucidrains/vit-pytorch](https://github.com/lucidrains/vit-pytorch)
- https://github.com/berniwal/swin-transformer-pytorch/tree/master
